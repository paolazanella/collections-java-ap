...
public class ListaTarefa {
    //atributo
    private List<main.java.list.OperacoesBasicas.Tarefa> tarefaList;
    ...
    public void adicionarTarefa(String descricao) {
        tarefaList.add(new main.java.list.OperacoesBasicas.Tarefa(descricao));
    }

    public void removerTarefa(String descricao) {
        List<main.java.list.OperacoesBasicas.Tarefa> tarefasParaRemover = new ArrayList<>();
